...
if __name__ == '__main__':
    freeze_support()
    sat2021_files = [(file, open(os.path.join('sat2021', file), 'r').readline().split()[2])
                     for file in os.listdir('sat2021')]
    ...
    for example in unsat2021_files:
        ...
        # example = '90fda6e7338d52aeb796636fde412daf-battleship-12-12-unsat'
        ans_file = os.path.join('answers', 'sat2021', f'{example}.ans')
        cnf_file = os.path.join('sat2021', f'{example}.cnf')
